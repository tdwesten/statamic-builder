...
@section('content')
    <div class="card p-0 content">
        <div class="py-6 px-8 border-b">
            <h1>{{ __('Blueprint not editable') }}</h1>
            <p>{{ __('Because this blueprint is registered with the Statamic Builder it\'s only editable in PHP.') }}</p>
        </div>
        <div class="flex flex-wrap p-4">
            <a href="vscode://file/{{ $blueprintPath }}"
            ...
            <a href="idea://open?file={{ $blueprintPath }}"
                class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 rounded-md group">
                <div class="h-8 w-8 mr-4 text-gray-800">
                    ...
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g>
                            <g>
                                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="0.558" y1="46.8457"
                                    x2="29.9473" y2="8.0256">
