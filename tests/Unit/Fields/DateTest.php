...
use Tdwesten\StatamicBuilder\FieldTypes\Date;

it('can render to a array', function (): void {
    $field = new Date('title');
...
it('can render to a array with mode', function (): void {
    $field = new Date('title');
    $field->mode(DateModeOption::Range);
...
it('can render to a array with earliest date', function (): void {
    $field = new Date('title');
    $field->earliestDate(new Carbon('2021-01-01'));
...
it('can render to a array with latest date', function (): void {
    $field = new Date('title');
    $field->latestDate(new Carbon('2021-01-01'));
