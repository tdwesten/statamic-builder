...
use Tdwesten\StatamicBuilder\FieldTypes\Code;

it('can render to a array', function (): void {
    $field = new Code('title');
...
test('you can set the indent type', function (): void {
    $field = new Code('title');
    $field->indentType(CodeIndentTypeOption::Tabs);

    expect($field->toArray()['field']['indent_type'])->toBe(CodeIndentTypeOption::Tabs->value);
});
...
test('you can set the key map', function (): void {
    $field = new Code('title');
    $field->keyMap(CodeKeyMapOption::Vim);

    expect($field->toArray()['field']['key_map'])->toBe(CodeKeyMapOption::Vim->value);
});
