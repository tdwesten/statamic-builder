...
test('it can render to a array with buttons', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
    $field->buttons([
...
test('Can set a asset folder', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
    $field->folder('folder');
...
test('Can resetrict to a asset folder', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
...
test('can set automatic line breaks', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
...
test('can set automatic links', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
...
test('can set escape markup', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
...
test('can set heading anchors', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
...
test('Can set smartypants', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
...
test('Can enable table of contents', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
...
test('Can define parser', function () {
    $field = new \Tdwesten\StatamicBuilder\FieldTypes\Markdown('title');
